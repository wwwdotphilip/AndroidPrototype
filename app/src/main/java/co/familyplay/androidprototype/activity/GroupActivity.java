...
public class GroupActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post = (RecyclerView) findViewById(R.id.lvPost);
        pb = (ProgressBar) findViewById(R.id.pbProgress);

        pd = new ProgressDialog(context);
        pd.setMessage("Uploading post...");
        prefs = context.getSharedPreferences("appData", Context.MODE_PRIVATE);
                            ...
                            public void onClick(DialogInterface dialog, int position) {
                                ...
                                switch (position) {
                                    ...
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        intent = new Intent(context, CreateGIFActivity.class);
            ...
            case SELECT_PHOTO:
                if (resultCode == Activity.RESULT_OK) {
                    try {
                        ...
                        String imageurl = Bmp.getSelectedPath(selectedImageUri, GroupActivity.this);
                        Bitmap bmp = Bmp
                                .decodeSampledBitmapFromResource(imageurl, 200,
                                        200);
                        if(checkifGif(imageurl)){
                        ...
                        query.findInBackground(new FindCallback<Vote>() {
                            ...
                            public void done(List<Vote> list, ParseException e) {
                                if (e == null) {
                                    ...
                                    pb.setVisibility(View.GONE);
                                    adapter = new co.familyplay.androidprototype.adapter.PostListAdapter(postList,
                                            new PostListDataChangedListener(), context, GroupActivity.this);
